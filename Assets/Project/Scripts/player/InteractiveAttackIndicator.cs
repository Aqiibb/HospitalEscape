...
{
    public class InteractiveAttackIndicator : MonoBehaviour
    {
        [Header("Viewpoint")]
        ...
        {
            Collider[] hitColliders = Physics.OverlapSphere(transform.position, MaxTextViewRange, interactableLayer);
